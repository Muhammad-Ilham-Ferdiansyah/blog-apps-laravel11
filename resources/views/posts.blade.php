            ...
            <article
                ...
                <div class="flex justify-between items-center mb-5 text-gray-500">
                    <a href="/posts?category={{ $post->category->slug }}">
                        <span
                            ...
                            <svg class="mr-1 mb-0.5 w-3 h-3" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="{{ $post->category->icon_path }}"></path>
                            </svg>
                            {{ $post->category->name }}
                        </span>
                    </a>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <a href="/posts/{{ $post->slug }}"
                        class="inline-flex items-center font-medium text-xs text-primary-600 dark:text-primary-500 hover:underline">
                        Read more
